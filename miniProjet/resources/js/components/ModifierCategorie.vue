            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Modifier</h3>
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-horizontal form-material mx-2" @submit.prevent="modifiercategorie">
                                    <input type="hidden" name="new" value="1" />
                                    <div class="form-group">
                                        
                                        <label class="col-md-12 mb-0">Categorie</label>
                                        <div class="col-md-12">
                                            <input type="text" name="nomcategorie" placeholder="nomcategorie" v-model="categorie.nomcategorie"
                                                class="form-control ps-0 form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12 d-flex">
                                            <input class="btn btn-success mx-auto mx-md-0 text-white" name="submit" type="submit" value="Modifier"  />
                                        </div>
                                    </div>
                                </form>
                            </div>
...
export default {
 ...
 modifiercategorie(){
 this.axios.patch(`http://localhost:8000/api/categories/${this.$route.params.id}`,this.categorie)
 .then(() => {
